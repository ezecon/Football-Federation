...
export default function Events() {
    return (
      <div className="py-28 water-text">
        <h2 className="font-playwrite-gb-s text-center text-3xl mb-8">Events</h2>
        <h2 className="font-playwrite-gb-s text-center text-3xl mb-8">Events</h2>
        ...
        <div className="flex flex-col lg:flex-row mt-28 p-4 lg:p-16 gap-8">
          ...
          <div className="w-full lg:w-7/12 h-full">
            ...
            During the last Eid ul Adha occasion, a friendly football tournament was held, and Islamia
            Football Academy participated in the junior section and won the tournament. They received
            the trophy from the president of the Bus Malik Samiti, who organized the tournament. A
